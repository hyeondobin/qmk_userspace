...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LED] = LAYOUT(
        _______,   _______,     _______,    _______,    _______,    _______,    _______,        _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,   RM_ON,       RM_OFF,     RM_NEXT,    RM_PREV,    _______,    _______,        _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,   RM_HUEU,     RM_HUED,    RM_SATU,    RM_SATD,    _______,    _______,        _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,   RM_VALU,     RM_VALD,    RM_SPDU,    RM_SPDD,    _______,                                _______,    _______,    _______,    _______,    _______,    _______,
        _______,   _______,     _______,    _______,    _______,                _______,        _______,                _______,    _______,    _______,    _______,    _______,
                                                        _______,    _______,    _______,        _______,    _______,    _______
                    ),
    [_FNC] = LAYOUT(
        _______,   _______,     _______,    _______,    _______,    _______,    _______,        _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,   _______,     _______,    _______,    _______,    _______,    _______,        _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,   KC_F6,       KC_F4,      KC_F10,     KC_F2,      _______,    _______,        _______,    _______,    KC_F3,      KC_F1,      KC_F5,      KC_F7,      _______,
        _______,   _______,     _______,    KC_F12,     KC_F8,      _______,                                _______,    KC_F9,      KC_F11,     _______,    _______,    _______,
        _______,   _______,     _______,    _______,    _______,                _______,        _______,                _______,    _______,    _______,    _______,    _______,
                                                        _______,    _______,    _______,        _______,    _______,    _______
    ),
    [_GUI] = LAYOUT(
